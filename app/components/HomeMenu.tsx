...
export const HomeMenu: React.FC<SidebarModalProps> = ({ isOpen, onClose }) => {
    return (
        <>
            {/* Sidebar Modal */}
            <div
                className={`fixed top-0 right-0 h-full w-[50%] md:w-[30%] flex flex-col bg-[#E2EAF4] shadow-lg z-50 transition-transform duration-300 rounded-lg ${
                    isOpen ? "translate-x-0" : "translate-x-full"
                }`}
            >
                <div className="p-4 flex mt-8 justify-between items-center border-b">
                    <h2 className="text-lg font-bold text-purple-500">Home</h2>
