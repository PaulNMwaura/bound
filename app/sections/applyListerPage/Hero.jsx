...
export const Hero = () => {
    ...
    return (
        <section className="md:container bg-white pt-4 pb-20 md:rounded-lg md:mt-5">
            <form className="px-2">
                {/* Photo Upload */}
                ...
                <div className="mt-4">
                    <h3 className="text-lg font-semibold text-center py-2">Set your availability</h3>
                ...
                {/* Submit Button */}
                <button type="submit" className="bg-black text-white px-4 py-2 rounded mt-4 w-full">Register</button>
                <button onClick={handleReset} className="p-2">Clear All</button>
                {error && (
