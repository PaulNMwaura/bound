...
export const Hero = ({session}) => {
    return (
        <section>
            <div className="container flex flex-col justify-center items-center pt-30">
                ...
                <strong className="mt-2 text-xl md:text-4xl tracking-tight py-3">For Your Needs</strong>
