    ...
    return (
        <section>
            <div className="container h-[100vh] flex flex-col justify-center items-center -mt-10">
                <strong className="text-lg md:text-2xl tracking-tight text-purple-400">I Make It Easier</strong>
                <strong className="text-xl md:text-3xl tracking-tight">For Your Customers To Find You</strong>
                <p className="mt-2 tag outline-orange-500 opacity-90">A service marketplace that helps you manage your gigs</p>
