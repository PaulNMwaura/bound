...
export const Header = () => {
    return (
        <header className="md:container bg-white text-black md:rounded-b-lg">
            <div className="flex md:hidden flex-row justify-center items-center gap-1 py-1 bg-black text-xs text-center">
