...
export const plans = [
    {
        link: process.env.NODE_ENV === 'development' ? 'https://buy.stripe.com/test_4gwcOpbrIezR7IsfZ0' : '',
        priceId: process.env.NODE_ENV === 'development' ? 'prod_SCc4q6uzeARjeD' : '',
        price: 9.99,
        duration: '/month'
    },
    // {
                        ...
                        <div className=" w-full max-w-lg">
                            <div className="relative flex flex-col h-full gap-5 lg:gap-8 z-10 bg-base-100 p-8 rounded-xl">
                                ...
                                <div className="space-y-2">
                                    <a
                                        className="btn btn-primary-alt btn-block "
                                        target="_blank"
                                        href={
                                            plan.link +
                                            '?prefilled_email=' +
